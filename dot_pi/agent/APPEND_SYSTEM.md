...
Use the user's commit message style with one of these prefixes: `chore:`, `fix:`, or `feat:`.

## Response confidence

End every assistant response with a final line formatted as `**Confidence:** High`, `**Confidence:** Medium`, or `**Confidence:** Low`, reflecting confidence in the answer. If needed, briefly expand after the High/Medium/Low level.
